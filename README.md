...
Переключение доступно как в CLI (`python app/cli.py --device ...`) так и в GUI (настроечно в будущих вкладках). При отсутствии GPU приложение автоматически падает обратно на CPU.
